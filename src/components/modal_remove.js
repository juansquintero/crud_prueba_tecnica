...
const ModalRemove = ({ props, children, status, statusChange }) => {
  return (
    <>
      {status && (
        <Overlay>
          <Container>
            ...
            <Container1>
              ...
              <Text10>1037213123123</Text10>
              <Text11>Activo</Text11>
              <Text12>
                Pepito Perez
                <span
              ...
              <Text13>Perez Pepito</Text13>
              <Text14>3123123122</Text14>
              <Text15>Calle 14 # 14-14A</Text15>
              <Text16>Bogollin</Text16>
            </Container1>
            <Container2>
